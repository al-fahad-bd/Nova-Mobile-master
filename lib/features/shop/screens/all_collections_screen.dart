        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              SearchSpace(controller: brandSearchController, prefixIcon: const Icon(IconlyLight.search), hintText: "search collections"),
              Expanded(
                child: TabBarView(
                  children: [
                    //woman
                    GridView.builder(
                      gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, childAspectRatio: 0.7, crossAxisSpacing: 1, mainAxisSpacing: 10),
                      itemCount: collectionImage.length,
                      itemBuilder: (BuildContext context, int index) {
                        return DesignerCollections(productImage: collectionImage[Random().nextInt(collectionImage.length)]);
                      },
                    ),
                    //Men
                    GridView.builder(
